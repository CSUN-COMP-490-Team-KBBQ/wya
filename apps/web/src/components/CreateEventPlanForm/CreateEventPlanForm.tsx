...
export default function CreateEventPlanForm(): JSX.Element {
    ...
    const onSubmitHandler = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        /** Transform */
        // Converting to 24 hour format for firestore
        formValues.dailyStartTime = moment(formValues.dailyStartTime, [
            'hh:mm A',
        ]).format('HH:mm');
        formValues.dailyEndTime = moment(formValues.dailyEndTime, [
            'hh:mm A',
        ]).format('HH:mm');
